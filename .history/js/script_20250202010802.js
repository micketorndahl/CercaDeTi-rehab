document.addEventListener("DOMContentLoaded", function () {
  ...
  if (imageElement) {
    ...
    function changeImage() {
      ...
      imageElement.style.transition = "opacity 1s ease-in-out"; // Smooth transition for opacity
      ...
      }, 1000); // Delay the fade-in until the fade-out is complete
    }

    setInterval(changeImage, 6000); // Change image every 8 seconds for a longer delay
  } else {

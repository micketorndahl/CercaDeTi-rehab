...
document.addEventListener("DOMContentLoaded", function () {
  ...
  imageList.push(`/images/group-training.jpg`);
  imageList.push(`/images/group-training2.jpg`);
  imageList.push(`/images/rehab-sneekpeak.jpg`);
  imageList.push(`/images/walking-in-stairs-rehab.jpg`);
  imageList.push(`/images/rehabcloseup.jpg`);
  imageList.push(`/images/walking-rehab.jpg`);
  imageList.push(`/images/walking-rehab2.jpg`);
  imageList.push(`/images/relax.jpg`);
  imageList.push(`/images/pool-rehab.jpg`);
  imageList.push(`/images/morning-gymnastics.jpg`);
  imageList.push(`/images/professional-help.jpg`);
  imageList.push(`/images/gym-wide.jpg`);

...
document.addEventListener("DOMContentLoaded", function () {
  // Your existing code that adds the event listener to the scroll button
  ...
  // Add your gallery or other scripts here
  // (image slider, etc.)
});
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function changeImage() {
    ...
    imageElement.style.transition = "opacity 0.5s ease-in-out"; // Apply transition
